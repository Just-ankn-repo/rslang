        ...
        img1.onload = () => {
            ...
            groupsWords.forEach((words, i) => {
                ...
                words.forEach((w, j) => {
                    ...
                    ctx.clip();
                    if (imgflag)
                        ctx.drawImage(img1, startXPointCropImage, startYPointCropImage, canvasWidth + radius, canvasHeight, 0, 0, canvasWidth + radius, canvasHeight);
                    else ctx.drawImage(img2, startXPointCropImage, startYPointCropImage, canvasWidth + radius, canvasHeight, 0, 0, canvasWidth + radius, canvasHeight);
